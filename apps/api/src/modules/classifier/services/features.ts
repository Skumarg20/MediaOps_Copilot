...
/**
 * The feature vector is the contract between offline training and online
 * inference. Both sides import THIS module, so serving skew is structurally
 * impossible rather than merely unlikely: the dataset is generated by running
 * this extractor, and the exported weights index into `FEATURE_NAMES`.
 */
